package shiyiliang.cn.basetool.widget;
...
public class PayPasswordView extends AppCompatEditText {
    ...
    private OnInputCompelte mOnInputCompelte;
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        //获取我们定义的密码框的类型
        psdType = typedArray.getInt(R.styleable.PayPsdInputView_passwordType, psdType);
...
//       super.onDraw(canvas);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (mOnInputCompelte != null && textLength == maxCount) {
            mOnInputCompelte.passwordComplete(getPasswordString());
        }
        invalidate();
    ...
    public void setOnPasswordListener(OnInputCompelte listener) {
        this.mOnInputCompelte = listener;
    }
     ...
     * 密码输完后的接口
     */
    public interface OnInputCompelte {
